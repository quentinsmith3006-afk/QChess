...
public class Rook extends ChessPiece {
    ...
    public List<ChessDirection> getRawPlayableDirections() {
        ...
        BoundedPieceVector downwardVector = new BoundedPieceVector(this.coordinate, 1, 0, BoundedPieceVector.INF);
        BoundedPieceVector rightwardVector = new BoundedPieceVector(this.coordinate, 0, 1, BoundedPieceVector.INF);
