...
--> This vector is automatically generated with its terminal point set to a chess piece specified in the vectors creation. (This vector basically connects 2 chess pieces).
